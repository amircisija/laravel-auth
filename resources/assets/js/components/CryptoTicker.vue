      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr v-cloak v-for="coin in coins">
            ...
            <td><img width="40" v-bind:src="getCoinImage(coin.symbol)"></td>
            <td class="price--wrapper">{{ ((coin.price_eur | currency)  * bamToEuro).toFixed(2) }}</td>
...
export default {
  ...
  methods: {
    ...
    getCoins: function() {
      ...
      axios
        .get(COINMARKETCAP_API_URI + "/v1/ticker/?convert=EUR&limit=5")
        .then(resp => {
